...
public:
	...
	void SetAbsOrigin(Vector origin)
	{
		...
		if (!SetAbsOrigin)
			SetAbsOrigin = (SetAbsOriginFn)((DWORD)Utils::FindSignature("client_panorama.dll", "55 8B EC 83 E4 F8 51 53 56 57 8B F1 E8 ?? ??"));
	...
	void SetAbsAngles(QAngle angle)
	{
		...
		if (!func)
			func = (Fn)(Utils::FindSignature("client_panorama.dll", "55 8B EC 83 E4 F8 83 EC 64 53 56 57 8B F1 E8"));
